        ...
        "products": [
            {
                ...
                "title": row[2],
                "brand": row[3],
                "buyout_percent": row[4] or 0,
                "order_count": row[14] or 0,
                "order_sum": round(float(row[15] or 0), 2),
                "sales_count": row[5],
                "sales_revenue": round(float(row[6] or 0), 2),
                "returns_count": row[7],
                "returns_revenue": round(float(row[8] or 0), 2),
                "net_payout": round(float(row[9] or 0), 2),
                "profit_estimate": round(float(row[10] or 0), 2),
                "cost_price_estimate": round(float(row[11] or 0), 2),
                "logistics_cost": round(float(row[12] or 0), 2),
                "storage_cost": round(float(row[13] or 0), 2),
            }
            for row in rows
        ],
    }
